  ...
  return (
    <div className='row'>
      <div className='col-5'>
        ...
        <img width={200} style={{ display: 'block', marginBottom: 76 }} src={faceScanIcon} />

        <div className='footer-btn-style'>
          <Button size='large' onClick={() => props.onBack()} style={{ marginRight: 30 }}>
            Back
          </Button>
          <Button loading={loader} size='large' type='primary' onClick={() => verifyLiveness()}>
            Next
          </Button>
        </div>
      </div>
      <div className='col-7'>
        ...
        <div className='capture-render-area'>
          ...
          {showCamera && selfieImage.length > 0 && (
            <img src={selfieImage} style={{ width: 410, height: 250 }} />
          )}
